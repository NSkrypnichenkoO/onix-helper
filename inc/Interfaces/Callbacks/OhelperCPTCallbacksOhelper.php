...
class OhelperCPTCallbacksOhelper extends OhelperBaseCallbacks
{
  ...
  {
    $args['object_edit_mode'] = $this->cpt_edit_mode();
  ...
  public function checkbox_with_default_field(array $args)
  {
    ...
    $this->create_checkbox_with_default_option($args, $edit_cpt);
  }
  ...
  {
    $edit_cpt = $this->cpt_edit_mode();
    $this->create_simple_select($args, $edit_cpt);
  }
  ...
  public function multi_select_field(array $args)
  {
    ...
    $this->create_multiple_select($args, $edit_cpt, $options);
  }

  ...
  public function set_fields()
  {
    $args = [
      ...
      [
        ...
        'callback' => [$this->fields_callbacks, 'multi_select_field'],
        'page' => 'onix_meta_box_fields',
        'section' => 'onix_meta_box_fields_index',
        'args' => [
          'option_name' => 'onix_meta_box_fields',
      ...
      [
        'id' => 'fields_section_repeater_max_count',
        'title' => 'fields_section_repeater_max_count',
        'callback' => [$this->fields_callbacks, 'text_field'],
        'page' => 'onix_meta_box_fields',
        'section' => 'onix_meta_box_fields_index',
        'args' => [
          'option_name' => 'onix_meta_box_fields',
          'label_for' => 'fields_section_repeater_max_count',
          'placeholder' => 'live empty to dont use repeater or enter number',
          'required' => false,
          'array' => 'taxonomy',
          'description' => 'Live empty to dont use section as repeater or enter 1. to have unlimited item enter -1.'
        ]
      ],
  ...
  public function store_field_sections()
  {
    ...
    foreach ($options as $option) {
      ...
      $args = array(
        ...
        'fields' => array(
          'max_section_count' => (isset($option['fields_section_repeater_max_count']) && ($option['fields_section_repeater_max_count'] != "")) ? $option['fields_section_repeater_max_count'] : 1,

...
class OhelperCPTControllerOhelper extends OhelperBaseController
{
    ...
    $args = [
      ...
      [
        ...
        'args' => [
          ...
          'label_for' => 'public',
          'class' => 'ui-toggle',
          'has_default' => [$this->cpt_callbacks, 'render_switcher_checkbox_tax'],
  ...
  public function store_custom_post_types()
  {
    ...
    foreach ($options as $option) {
      ...
      $args = [
        'labels' => [
          'name' => _x($name, 'Post type general name', 'onix-helper'),
          'singular_name' => _x($single_name, 'Post type singular name', 'onix-helper'),
          'menu_name' => _x($name, 'Admin Menu text', 'onix-helper'),
          'name_admin_bar' => _x($single_name, 'Add New on Toolbar', 'onix-helper'),
          'add_new' => __('Add new ' . $single_name, 'onix-helper'),
          'add_new_item' => __('Add new ' . $single_name, 'onix-helper'),
          'new_item' => __('New ' . $single_name, 'onix-helper'),
          'edit_item' => __('Edit ' . $single_name, 'onix-helper'),
          'view_item' => __('View ' . $single_name, 'onix-helper'),
          'all_items' => __('All ' . $name, 'onix-helper'),
          'search_items' => __('Search ' . $single_name, 'onix-helper'),
          'parent_item_colon' => __($single_name, 'onix-helper'),
          'not_found' => __($name . ' not found', 'onix-helper'),
          'not_found_in_trash' => __($name . ' not found in trash', 'onix-helper'),
          ...
          'archives' => _x($single_name . ' Archives', 'The post type archive label used in nav menus. Default “Post Archives”. Added in 4.4', 'onix-helper'),
          'insert_into_item' => _x('Insert into ' . $single_name, 'Overrides the “Insert into post”/”Insert into page” phrase (used when inserting media into a post). Added in 4.4', 'onix-helper'),
          'uploaded_to_this_item' => _x('Uploaded to this ' . $single_name, 'Overrides the “Uploaded to this post”/”Uploaded to this page” phrase (used when viewing media attached to a post). Added in 4.4', 'onix-helper'),
          'filter_items_list' => _x('Filter ' . $name . ' list', 'Screen reader text for the filter links heading on the post type listing screen. Default “Filter posts list”/”Filter pages list”. Added in 4.4', 'onix-helper'),
          'items_list_navigation' => _x($name . ' list navigation', 'Screen reader text for the pagination heading on the post type listing screen. Default “Posts list navigation”/”Pages list navigation”. Added in 4.4', 'onix-helper'),
          'items_list' => _x($name . ' list', 'Screen reader text for the items list heading on the post type listing screen. Default “Posts list”/”Pages list”. Added in 4.4', 'onix-helper'),
        ],
        'post_type' => $pt,
      ];

...
<ul class="nav nav-tabs">
  <li class="<?php echo $edit_one ? '' : 'active' ?>">
    <a href="#tab-1"><?php echo __('Created Fields Sections', 'onix-helper') ?></a>
  </li>
  <li class="<?php echo $edit_one ? 'active' : '' ?>">
    <a
      href="#tab-2"> <?php echo $edit_one ? __('Edit ', 'onix-helper') . sanitize_title($_POST['edit_fields_section']) : __('Add new Fields Section', 'onix-helper') ?></a>
  </li>
</ul>
...
<div class="tab-content">
  <div id="tab-1" class="tab-pane <?php echo $edit_one ? '' : 'active' ?>">
    ...
    <table class="wp-list-table widefat fixed striped table-view-list">
      <thead>
      <tr>
        <th><?php echo __('Slug', 'onix-helper') ?></th>
          ...
          <tr>
            ...
            <td class="button-wrapper">
              <form method="post" action="">
                <input type="hidden" name="edit_fields_section" value="<?php echo $section_slug ?>">
              ...
              <form method="post" action="options.php">
                ...
                <input type="hidden" name="remove" value="<?php echo $section_slug ?>">
